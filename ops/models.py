...
class TSN(nn.Module):
    ...
    def get_optim_policies(self):
        ...
        conv_cnt = 0
        bn_cnt = 0
        from .depthwise_conv import DiagonalwiseRefactorization
        for name, m in self.named_modules():
            if 'nl' in name and isinstance(m, (nn.Conv1d ,nn.Conv2d, nn.Conv3d, DiagonalwiseRefactorization, nn.BatchNorm3d, nn.BatchNorm2d, nn.BatchNorm1d, nn.SyncBatchNorm)):
