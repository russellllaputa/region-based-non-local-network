...
def return_kinetics(modality):
    ...
    if modality == 'RGB'or modality == 'HP':
        root_data = '/media/edward/ssd2/' + 'kinetics/images'
        filename_imglist_train = '/media/edward/ssd2/kinetics/labels/shuffled_train_videofolder.csv'
        filename_imglist_val = '/media/edward/ssd2/kinetics/labels/shuffled_val_videofolder.csv'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
